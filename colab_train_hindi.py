"""
Hindi-first Colab profile for EcoHybrid diffusion training.
...
def main() -> None:
    _set_default("--language", "hi")
    _set_default("--output_dir", "checkpoints/eco_hybrid_hi")
    ...
    _set_default("--romanized_ratio", "0.20")
    _set_default("--include_gujlish")
    _set_default("--gujlish_ratio", "0.10")
